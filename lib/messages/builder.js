...
function builder(options) {
  ...
  if (!options.network) {
    options.network = rtmcore.Networks.defaultNetwork;
  }

  options.Block = options.Block || rtmcore.Block;
  options.BlockHeader = options.BlockHeader || rtmcore.BlockHeader;
  options.Transaction = options.Transaction || rtmcore.Transaction;
  options.MerkleBlock = options.MerkleBlock || rtmcore.MerkleBlock;
