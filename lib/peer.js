 ...
 * using the standard Raptoreum protocol. A Peer instance represents one connection
 * on the Raptoreum network. To create a new peer connection provide the host and port
